...
class Game:
	def __init__(self):
		...
		#musica y sonido
		music = pygame.mixer.Sound('D:/Downloads/jueguito/audio/music.wav')
		music.set_volume(0.1)
		music.play(loops = -1)
		self.laser_sound = pygame.mixer.Sound('D:/Downloads/jueguito/audio/laser.wav')
		self.laser_sound.set_volume(0.1)
		self.explosion_sound = pygame.mixer.Sound('D:/Downloads/jueguito/audio/explosion.wav')
